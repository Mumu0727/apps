                ...
                <div class="row">
                    <div class="col-md-12 tal mt20">
                        <form  id="theForm"  name="theForm" class="form-signin"  action="/p/j_spring_security_check" method="POST" >
                            ...
                            <div class="clear"></div>
                            <div class="btn_box">
                                <div class="col-xs-6 p0"><button type="button" class="btn btn-info btn-block" 
                                @click="login"
                                >登  陆</button></div>
                                <div class="col-xs-5 p0" style="margin-left:10px;"><router-link type="button" class="btn btn-default btn-block" to='/reg'>注 册</router-link ></div>
                                </div>
                        </form>
                    </div>
                </div>

...
.container{margin:0 0 10px 0;padding: 0 !important; background-color:#e5e5e5;width: 100%;}
.sort-tit{border-bottom:1px solid #e5e5e5; padding:10px; color:#6a94e7; margin:0;font-size: 18px;}

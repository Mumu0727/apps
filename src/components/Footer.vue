...
.active{color: #428bca !important;}
.foot-con a{display: block; width:25%; float:left; text-align:center; font-size: 12px; position:relative;color: #666;text-decoration:none}
